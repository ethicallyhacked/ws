...
func=>run() {
  if(event.keyCode == 13) {
    ...
    if (a == 'list' || a == 'a*help') {
      ...
      '<e>"list"</e> to see all commands<br>'+
      '<e>"connect"</e> to connect to a server<br>'+
      '<e>"engage"</e> to show matrix display<br>'+
      '<e>"creator"</e> to see code info<br>'+
      '<e>"info"</e> to see some easter egg info<br>'+
      '<e>"show_date"</e> to show current time<br>'+
      '<e>"recursion"</e> to run recursion<br>'+
      '<e>"randomize_ip"</e> to randomize your IP<br>'+
      '<e>"hack_codepen"</e> to hack codepen server<br>'+
      '<e>"error"</e> to show an error looks<br>'+
      '<e>"error_403"</e> to see a forbidden function<br>'+
      '<e>"error_404"</e> to see a thing that is not in there<br>'+
      '<e>"special"</e> to see my thank you to you all<br>'+
      '<e>"guess_game"</e> to play guess game here<br>'+
      '<e>"screen_data"</e> to get screen info<br>'+
      '<e>"browser_data"</e> to get browser info';
    }
    ;; If Command Is Creator
    elif (a == 'creator' || a == 'a*maker') {
      $('#cmd')_$html = '<b>About</b><br>'+
      'Created by: <e>RISHABH MISHRA</e><br>'+
      'Created on: <e>4 FEB 2019</e><br>'+
      'Technology: <e>HTML, CSS, JS</e><br>'+
      'Frameworks: <e>NeoIonJS</e>';
    }
    ;; If Command Is Info
    elif (a == 'info' || a == 'a*i') {
      $('#cmd')_$html = 'Info<br>'+
...
func=>matrix() {
  ...
  ;; Setting Text
  num = '1111101001000100100101001001001010';
  size = 10;
  num = num.split('');
...
func=>hack() {
  ...
  hackText = 'I_n_i_t_i_a_l_i_z_i_n_g_._._._<br>'+
    ...
    '_Username_:_ _<e>Codepen</e>_<br>'+
...
;; Special
func=>special() {
  $('#cmd')_$html = '<b>Special Thanks To  My Friends, My Followers, and SoloLearn</b><br><br>'+
  ...
  'thanks to my friend, <e>Vishal</e>, that is supporting me here<br><br>'+
